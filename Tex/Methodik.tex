...
Die Beschränkungen 30er-Zonen und Spielstraßen sollen mit dem Code Segment aus Abbildung \ref{cod:zone} übergangen werden.
Wichtig ist dabei, dass der OSM-Tag \todo{java}{highway=living\_street} nicht automatisch eine Spielstraße ist.
...
Häufig wird solchen Straßen der Tag \todo{java}{maxspeed=7} zugewiesen.
...
Um Bus- und Taxispuren für das Profil nutzbar zu machen wurde das Code Segment \ref{cod:bus} implementiert.
...
Durch das den Code in Abbildung \ref{cod:weight} sollen die höchste Priorität Straßen mit dem Tag \todo{java service=emergency\_access} erhalten.
