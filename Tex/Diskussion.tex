...
Diese können nicht mit der erlaubten Geschwindigkeit gefahren werden, wurden jedoch nicht als Abbiegung registriert, da sie innerhalb eines Wegsegmentes liegen.
}
\label{fig:curve}
...
Die Zeitdifferenzen aus Tabelle \ref{tab:all} zeigen: das Profil fährt dem echten Fahrzeug mit der derzeitigen Gewichtung über die ganze Strecke vorraus.
...
\par\justifying\scriptsize
Die Verzögerung durch diese enge Unterführung auf der zweiten Teststrecke wurde durch das Profil für Löschfahrzeuge nicht berücksichtigt.
}
...
\label{fig:turnworld}
\end{subfigure}
\caption[Teststrecke 3 -- Vergleich eines Abbiegevorgangs]
{\centering Teststrecke 3 -- Vergleich eines Abbiegevorgangs
\par\justifying\scriptsize
Diese Abbiegung befindet sich zwischen Gablingen und Holzhausen.
Die Kurve ist in OSM im rechten Winkel eingetragen (a).
In der Wirklichkeit ist der Öffnungswinkel der Kurve allerdings größer (b).
}
\label{fig:turn}
\end{figure}
