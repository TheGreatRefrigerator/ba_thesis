...
Es kann nicht auf jeder Straße mit maximaler Geschwindigkeit gefahren werden. Deswegen werden für unterschiedliche Straßentypen unterschiedliche Geschwindigkeitsmaxima festgelegt. Hier werden die \textit{Values}(Werte) des \gls{osm} \textit{Keys} (Schlüssel) \lstinline!highway! verwendet. 
Für genauere Beschreibungen der Typen: https://wiki.openstreetmap.org/wiki/DE:Key:highway

Bisherige Angaben für Schwerfahrzeuge (HGV-Profil des \gls{ors}) in km/h
...
residential (Straße an und in Wohngebieten) : bisher 50
