...
\label{tab:speedinfo}
\centering
\caption{Standardgeschwindigkeiten für unterschiedlichen highway Values}
\begin{tabular}{|l|r|}
\hline
\multicolumn{1}{|l|}{highway Value}  & \multicolumn{1}{|c|}{\textit{km/h}} \\
\hline
...
tertiary\_link  & 50 \\
unclassified (Nebenstraße (oft keine Mittellinie))  & 60 \\
...
Damit ist der prozessierungs  Teil des Profils fertig gestellt. Es können an die Schnittstelle des ORS nun Routing-Anfragen mit dem neuen Profil gestellt werden
