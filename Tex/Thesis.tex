...
Die Ersten Ergebnisse lieferten zu erwartende Resultate. Die Emergency Profile konnten in der gleichen Zeit einen größeren Bereich abdecken.
mehr blabla
+ bilder isos 
...
Um genaue Anpassungen am Backend vorzunehmen wurde eine weitere Testfahrt durchgeführt, bei der für jede volle Minute der Aufenthaltsort des Fahrzeuges markiert wurde (Abb. \ref{}).
...
\begin{table}[h]
\centering
\caption{Fahrt 1 -- 2. Auswertung}
\label{tab:drive1}
\begin{tabular}{|l|r|r|}
\hline
Wegpunkt & Sekunden & Differenz \\ \hline 
1min & 78,3 & +18,3 \\
2min & 138.5 & +18,5 \\
3min & 188.5 & +8,5 \\
4min & 226.7 & -3,3 \\
...
Diese Kalibrierung wurde an zwei weiteren Testfahrten (Abb. \ref{} und \ref{}) vom selben Ausgangspunkt überprüft.

In den Tabellen \ref{tab:} und \ref{tab:} ist zu sehen, das 8 von 10 Wegpunkten um mehr als 20 Sekunden, in 3 Fällen sogar 40 Sekunden zu spät erreicht werden.
...
Durch die eingebauten Funktionen wurde ersichtlich, dass bei der Berechnung der Zeit bisher die Steigung als entscheidender Faktor vergessen wurde \ref{steig}.
...
Für die Abbildung () liegt das Copyright bei \copyright 2017 Google für die Bilder und \copyright 2017 GeoBasis-DE/BKG für die Kartendaten.
