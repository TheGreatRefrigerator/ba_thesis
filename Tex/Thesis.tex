...
Ziel der vorliegenden Bachelorarbeit war es ein prototypisches Routing-Profil für Löschfahrzeuge in einer Forschungskooperation mit der Freiwilligen Feuerwehr Lützelburg zu entwickeln. Bisher gibt es keinen Routing-Service der die Tatsache berücksichtigt, dass Einsatzfahrzeuge im Notfall alle Vorschriften der StVO vernachlässigen dürfen.
Auf Basis des Openrouteservice wurde ein Emergency Profil entwickelt, welches für Einsatzfahrzeuge adäquate Geschwindigkeiten verwendet, Einbahnstraßen, Radwege, Fußgängerzonen und weitere Wegtypen befahren darf. Die Verzögerung durch Beschleunigungs- und Abbremsvorgänge wurde anhand von Zeit-Penalties für Anfahrt, Abbiegevorgänge und Ankunft berücksichtigt.
Das Profil wurde durch Analytische Vergleichen zwischen den Fahrtzeiten von drei durchgeführten Testfahrten kalibriert. Die Ergebnisse zeigen, dass eine Funktion für die Steigung eingebaut werden muss. Die Fahrzeiten für die Minuten Marker der weitgehend ebenen Teststrecken liegen nahezu komplett im +-10-Sekunden-Bereich. Eine Interessante weiterführende Forschungsarbeit ist die Suche von Hydranten im Zielgebiet, welche durch den Locations-Service des Openrouteservice verwirklicht werden kann. Der Autor erhofft sich mit dieser Arbeit eine Grundlage für exaktere Routenfindung für Notfallfahrzeuge so wie Hilfestellung bei der Entwicklung von Bedarfsplänen zu liefern.
